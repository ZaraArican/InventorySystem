...
<a class="active" href="deletep.php"style="text-decoration: none">Delete</a>
...
<li><a href="insert.php"style="text-decoration: none">Insert</a></li>
<li><a class="active" href="deletep.php"style="text-decoration: none">Delete</a></li>
<li><a href="search.html" style="text-decoration: none">Search</a></li>
<li><a href="logout.php" style="text-decoration: none">Logout</a>
            ...
            <?php
                if ($resultCheck > 0){
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td><a href=\"delete.php?PRODID=".
                        $row["PRODID"]."\">DELETE</a></td>";
                        echo"</tr>";
                    }
                }
            ?>
